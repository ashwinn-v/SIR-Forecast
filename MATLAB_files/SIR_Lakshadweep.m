...
% Model Parameters  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
 ...
 a = 0.22;
  b = 0.0753;
  f = 3e4;     %scaling factor f=1.20e+07
  
  k0 = 1.15e-10;
  D0 = 5e6;    %Constants estimated by the non linear fitting  D0=2.20e+0.05  k0=1.103-0.7
...
%   Id = Idtot - Cd - Dd;
  ...
  load('Lakshadweep.mat')
  Ndays  = length(Lakshwadeep(:,1));  
  Idtot  = Lakshwadeep(:,1);
  Id     = Lakshwadeep(:,2);
  Dd     = Lakshwadeep(:,3);  
