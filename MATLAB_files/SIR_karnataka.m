...
% Model Parameters  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
 ...
 a = 0.22;
  ...
  k0 = 1.085e-10;
  D0 = 11e7;    %Constants estimated by the non linear fitting  D0=2.20e+0.05  k0=1.103-0.7
...
for n = 1 : num-1                               %Number of integration steps
  ...
  if n > 1800 && n < 2000; S(n) = 0.40; end 
 
  if n > 2200; S(n) = 0.20; end    
